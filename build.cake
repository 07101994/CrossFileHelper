...
var sln = new FilePath("CrossFileHelper.sln");
...
Setup(context => 
{
    Information(Figlet("CrossFileHelper"));
...
Task("PublishPackages")
    ...
    .WithCriteria(() => IsRepository("07101994/CrossFileHelper"))
    .WithCriteria(() => 
        StringComparer.OrdinalIgnoreCase.Equals(versionInfo.BranchName, "develop") || 
        IsMasterOrReleases())
    .Does (() =>
{
    if (StringComparer.OrdinalIgnoreCase.Equals(versionInfo.BranchName, "develop") && !IsTagged())
    {
